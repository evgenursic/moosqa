      ...
      input: [
        {
          ...
          content: [
            ...
            "Avoid abstract template metaphors such as center of gravity, stable center, memorable silhouette, background color, surface, seams, enough contrast to matter, or the strongest detail.",
