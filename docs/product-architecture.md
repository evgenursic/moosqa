...
- `/radar` shows saved releases, followed artist/label matches, and current follows for signed-in listeners.
...
1. Notification preference editing.
2. Digest job and delivery idempotency.
